...
Metro Icons is an open source SVG icon library featuring over 800+ glyphs and distributed as a font file. 
You can include icons in your project either using a CDN or using your favorite bundler.

:::tip
You can view a full list of icons on https://panda.metroui.org.ua/mif/core-pack
:::
