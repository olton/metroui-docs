...
| `--animated-border-colors` | #ff4545, #00ff99, #006aff, #ff0095, #ff4545 | Default colors for animated borders |
...
<div class="box" style="height: 300px; width: 300px;">
    <button class="button animated-border">Button</button>
    <div class="box animated-border"></div>
    <div class="box animated-border" style="--animated-border-colors: transparent 30%, var(--color-blue), var(--color-green)"></div>
    <div class="box animated-border-red"></div>
</div>
```
