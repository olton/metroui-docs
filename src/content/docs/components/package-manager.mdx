...
The Package Manager component provides a tabbed interface for displaying installation commands for different package managers (npm, pnpm, yarn, bun). 
It allows users to easily copy the correct installation command for their preferred package manager.
...
```html
<div data-role="package-manager" data-package="@olton/metroui"></div>
```
