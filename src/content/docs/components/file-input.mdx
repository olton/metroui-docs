...
:root {
    ...
    --file-drop-zone-hover-color: #3A3A3A;
...
### Button Mode
```html
<input type="file" data-role="file" data-mode="button">
```

### Drop Zone Mode
```html
<input type="file" data-role="file" data-mode="drop-zone">
```

### With Custom Label
```html
<input type="file" data-role="file" data-label="Upload Document">
```

### Multiple File Selection
```html
<input type="file" multiple data-role="file">
```

### With Custom Button Text
```html
<input type="file" data-role="file" data-button-title="Browse Files">
```