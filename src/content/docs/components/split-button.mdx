...
<div class="split-button">
  ...
  <button class="split dropdown-toggle">
    <span class="mif-chevron-down"></span>
  </button>
  <ul class="d-menu" id="split-dropdown" data-role="dropdown">
...
<div class="split-button">
  ...
  <button class="split outline dropdown-toggle">
    <span class="mif-chevron-down"></span>
  </button>
  <ul class="d-menu" id="split-dropdown-outline" data-role="dropdown">
    <li><a href="#">Option 1</a></li>
    <li><a href="#">Option 2</a></li>
    <li><a href="#">Option 3</a></li>
  </ul>
...
<div class="split-button">
  ...
  <!-- Dropdown component -->
  <ul class="d-menu" data-role="dropdown">...</ul>

  <!-- Or Dropdown menu -->
  <ul class="d-menu" data-role="dropmenu">...</ul>
</div>
```
