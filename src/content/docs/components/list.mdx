...
### List with Sorting
```html
<ul data-role="list" data-sort-class="sort-name" data-sort-dir="asc">
    <li><span class="sort-name">Charlie</span></li>
    <li><span class="sort-name">Alpha</span></li>
    <li><span class="sort-name">Bravo</span></li>
</ul>
```
