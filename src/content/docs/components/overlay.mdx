...
The Overlay component provides styling for creating overlays, backdrops, and splash screens that cover the entire viewport. 
It's commonly used with dialogs, modals, and loading screens to focus user attention and prevent interaction with underlying content.

:::note
It is an auxiliary component used to create other media components such as a `dialog`.
:::
