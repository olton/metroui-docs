...
<div>
    <SourceButton href="https://github.com/olton/dom" icon="github" text="Repository"/>
    <SourceButton href="https://www.npmjs.com/package/@olton/dom" icon="seti:npm" text="Package"/>
</div> 
...
`Dom` functions are functionally similar to `jQuery` and can be used as a replacement for `jQuery`. **Methods compatibility reaches 90%**.
