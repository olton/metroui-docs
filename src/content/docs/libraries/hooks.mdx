...
<div>
    <SourceButton href="https://github.com/olton/hooks" icon="github" text="Repository"/>
    <SourceButton href="https://www.npmjs.com/package/@olton/hooks" icon="seti:npm" text="Package"/>
</div> 
